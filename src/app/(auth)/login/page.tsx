...
export default function LoginPage() {
  ...
  async function handleOAuth(provider: "google" | "github") {
    ...
    setServerError("");
    try {
      const { loginWithOAuth } = await import("@/lib/services/auth");
    ...
    <div className="glass-card">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] text-[var(--text-primary)] hover:bg-[var(--background-secondary)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[var(--glass-bg)] text-[var(--text-muted)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" noValidate>
        ...
        <div className="flex justify-end">
          <Link
            href="/reset-password"
            className="text-sm text-navy-500 dark:text-navy-300 hover:underline"
          >
            Forgot password?
          </Link>
        </div>
